...
<body>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://web.facebook.com/vikry.surya.5/" target="_blank"><i
                        class="bi bi-whatsapp fs-3"></i></a>
                <a href="https://github.com/GhoziAnakRajin" target="_blank"><i class="bi bi-github fs-3"></i></a>
                <a href="https://www.instagram.com/ghozialfarrasi_?igsh=MWwxeGg0aXM4YXRxag%3D%3D&utm_source=qr"
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created by <u style="color: #fff;">Ghozi Alfarrasi</u></p>
    </footer>
    <!-- Close Footer -->
